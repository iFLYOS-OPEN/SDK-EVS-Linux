...
set(IOTJS_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/src)
...
if (NOT IOTJS_PROFILE)
    set(IOTJS_PROFILE "${CMAKE_CURRENT_SOURCE_DIR}/profiles/default.profile"
        CACHE STRING "Path to profile.")
endif()

if(NOT IS_ABSOLUTE ${IOTJS_PROFILE})
  message("CMAKE_CURRENT_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}")
  set(IOTJS_PROFILE "${CMAKE_CURRENT_SOURCE_DIR}/${IOTJS_PROFILE}")
endif()
...
list(APPEND LIB_IOTJS_SRC
  ${IOTJS_SOURCE_DIR}/iotjs_binding_cpp_helper.cpp
...
if(R328SOURCE)
  target_link_libraries(${TARGET_LIB_IOTJS}
          "-lr328record -lchannel"
          )
endif()

if(SNOWBOY)
  add_definitions("-DSNOWBOY")
  target_link_libraries(${TARGET_LIB_IOTJS}
    "snowboy-detect -latlas -lcblas -lsox"
  )
endif()

if(CAE)
  add_definitions("-DCAE")
  target_link_libraries(${TARGET_LIB_IOTJS} "-lhlw")
endif()

if (WPA_CLIENT)
  target_link_libraries(${TARGET_LIB_IOTJS} "-lwpa_client")
endif()

if (PORTAUDIO)
  target_link_libraries(${TARGET_LIB_IOTJS} ${PORTAUDIO_LIBRARY})
endif()
...
if(NOT BUILD_LIB_ONLY)
  ...
  target_link_libraries(${TARGET_IOTJS} ${TARGET_LIB_IOTJS} ${MBEDTLS_LIBS})
